...
public class EditarAutoParcial extends javax.swing.JDialog {

    private String cuenta;
    private String password;

    public EditarAutoParcial(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
        LookAndFeel();
    }
    ...
    private void Guardar() {
        try {
            ...
            if (textMarca.getText().isEmpty()) {
            ...
            } else if (textAno.getText().isEmpty()) {
                ...
                ano = textAno.getText();
                sql = sc.EditarAutoParcial(id,marca, tipo, transmision, ano);
                con.Conectar(cuenta, password);
                con.Modificar(sql);
                con.Cerrar();
                JOptionPane.showMessageDialog(this, "Auto guardado", "Editar auto parcial", JOptionPane.INFORMATION_MESSAGE);
                this.dispose();
            }
        } catch (Exception e) {
    ...
    void setUsuario(String cuenta, String password, int idAuto, String marca, String tipoAuto, String transmision, String ano) {
        this.cuenta = cuenta;
        ...
        comboTransmision.setSelectedItem(transmision);
        this.ano = ano;
        textAno.setText(ano);
    }
