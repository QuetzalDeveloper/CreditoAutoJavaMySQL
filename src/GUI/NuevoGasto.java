...
public class NuevoGasto extends javax.swing.JDialog {
    ...
    public NuevoGasto(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
        LookAndFeel();
    }
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/gasto.png"))); // NOI18N
    ...
    private void Guardar(){
        ...
        if(!dateFecha.getText().isEmpty()) {
            if (cantidad >= 0) {
                int op = JOptionPane.showConfirmDialog(this, "¿Seguro que desea guardar el gasto?");
                if (op == 0) {
                    ...
                    if(radioEfectivo.isSelected()){
                        ...
                        if (efectivo >= cantidad) {
                            ...
                            String sql = sc.GuardarGasto(fecha, 1, concepto, recibo, cantidad, origen);
                            ...
                            JOptionPane.showMessageDialog(this, "No se dispone de suficiente efectivo");
                        }
                    } else{
                        origen = 1;
                        if (tarjeta >= cantidad) {
                            ...
                            JOptionPane.showMessageDialog(this, "No se dispone de suficiente en tarjeta");
                        }
                    }
                }
            } else {
