...
public class EditarTablaCotizacion extends javax.swing.JDialog {
    ...
    public EditarTablaCotizacion(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
        LookAndFeel();
    } 
        ...
        if (!textCAT.getText().isEmpty()) {
            ...
            if (op == 0) {
                try {
                    ...
                    String sql;
                    sql = sc.EditarCotizacion(folio, idA, pA, eA, financiamiento, mensualidad, mA, comision, seguro, tasi, idC, date, idE, fecha,cat);
    ...
    void setUsuario(String cuenta, String password, int folio) {
        this.folio = folio;
        this.cuenta = cuenta;
